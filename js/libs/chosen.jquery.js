    ...
    Chosen = (function (_super) {
        ...
        Chosen.prototype.register_observers = function () {
            ...
            if(this.cancel_search) {
                ...
                this.search_field.bind('input',function (evt) {
        ...
        Chosen.prototype.search_field_disabled = function () {
            ...
            if (this.is_disabled) {
                ...
                if (!this.is_multiple) {
                    this.selected_item.bind("blur.chosen", this.deactivate_action); // bob:
        ...
        Chosen.prototype.choice_build = function (item) {
            ...
            t = $("<li />", {
                "class":"chosen-checkbox result-selected",
            ...
            if (item.disabled) {
                ...
                t.bind('click.chosen', function (evt) {
